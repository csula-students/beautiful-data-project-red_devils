...
public class SimpleModel {
	...
	private String contributed_to_accident;
	...
	public SimpleModel(String accident, String agency, String alcohol,
			...
			String description, String dl_state, String driver_city,
			String driver_state, String fatal, String gender, String hazmat,
			String location, String make, String model, String personal_injury,
			String property_damage, String race, String state,
	...
	public void setArrest_type(String arrest_type) {
		this.arrest_type = arrest_type;
	}
	...
	public String getContributed_to_accident() {
		return contributed_to_accident;
	}

	public void setContributed_to_accident(String contributed_to_accident) {
		this.contributed_to_accident = contributed_to_accident;
	}
	...
	public void setPersonal_injury(String personal_injury) {
		this.personal_injury = personal_injury;
	}
	...
	public static SimpleModel build(MockData data) {
		return new SimpleModel(data.getAccident(), data.getAgency(), data.getAlcohol(), data.getArrest_type(), 
				data.getArticle(), data.getBelts(), data.getCharge(), data.getColor(), data.getCommercial_license(), 
				data.getCommercial_vehicle(), data.getContributed_to_accident(), data.getDate_of_stop(), 
				data.getDescription(), data.getDl_state(), data.getDriver_city(), data.getDriver_state(),
				data.getFatal(), data.getGender(), data.getHazmat(), data.getLocation(), data.getMake(), 
				data.getModel(), data.getPersonal_injury(), data.getProperty_damage(), data.getRace(), data.getState(), 
				data.getSubagency(), data.getTime_of_stop(), data.getVehicle_type(), data.getViolation_type(), 
				data.getWork_zone(), data.getYear());
	}
}
